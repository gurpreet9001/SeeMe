...
class PostsFragment extends Fragment{
    ...
    //GET LIST OF ALL THE FRIENDS TO DISPLAY THERE POSTS IN OUT TIMELINE
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Moment,MomentsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Moment, MomentsViewHolder>(
         ...
         //IF POST IS BY CURRENT USER SHOW DELETE OPTION ON THE POST
                if(By.equals(Uid)){
           ...
           //DELETE POST FROM TIMELINE TAB
            ...
            // SHOW DESCRIPTION OF POST(namaste or ...) IF GIVEN DURING POSTING OF IMAGE
             ...
             //LIKE BUTTON ONE CLICK TO LIKE AND ANOTHER CLICK TO UNLIKE
...
//                        startActivity(commentIntent);
                ...
                //OPEN PROFILE OF PERSON WHO POSTED
...
//                        startActivity(profIntent);
                ...
                //SMALL ROUND DP AND NAME IN POST CARD
    ...
    //TIMELINE TAB ALL VARIABLES GETTER AND SETTER declaration
