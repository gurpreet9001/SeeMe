...
public class CommentsActivity extends AppCompatActivity {
    ...
    //FIRST LINE BELOW APPBAR TO SIGNIFY WHOSE POST
...
//LOAD THE PREVIOUS COMMENTS
    private void loadcomments(final String moment_id) {
        ...
        FirebaseRecyclerAdapter<Comments, CommentsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Comments, CommentsViewHolder>(
           ...
           //DELETE OPTIONS TO THE COMMENTS OF THE CURRENT SIGNED USER
                ...
                ///YET TO IMPLEMENT PROFILE OF USERS
...
//                        startActivity(profIntent);
          ...
          //SET NAME AND ROUND DP ON COMMENT
    ...
    public static class CommentsViewHolder extends RecyclerView.ViewHolder {
     ...
     //ACTION AFTER DELETING THE COMMENT
